...
export interface MediaSliceDefaultPrimary {
    /**
   * Spacing block field in *Media → Default → Primary*
   *
   * - **Field Type**: Boolean
   * - **Placeholder**: *None*
   * - **Default Value**: false
   * - **API ID Path**: media.default.primary.spacing_block
   * - **Documentation**: https://prismic.io/docs/field#boolean
   */
    spacing_block: prismic.BooleanField
...
export interface MediaSliceDuoMediaPrimary {
    /**
   * Spacing block field in *Media → DuoMedia → Primary*
   *
   * - **Field Type**: Boolean
   * - **Placeholder**: *None*
   * - **Default Value**: false
   * - **API ID Path**: media.duoMedia.primary.spacing_block
   * - **Documentation**: https://prismic.io/docs/field#boolean
   */
    spacing_block: prismic.BooleanField
