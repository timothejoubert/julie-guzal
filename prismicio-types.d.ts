...
interface ProjectPageDocumentData {
   ...
   */
  back_button_theme: prismic.SelectField<"dark" | "light", "filled">;
...
/**
 * Item in *ProjectFeed → Default → Primary → Project*
 */
export interface ProjectFeedSliceDefaultPrimaryProjectItem {
  /**
   * Project document field in *ProjectFeed → Default → Primary → Project*
   *
   * - **Field Type**: Content Relationship
   * - **Placeholder**: *None*
   * - **API ID Path**: project_feed.default.primary.project[].project_document
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
...
/**
 * Primary content in *ProjectFeed → Default → Primary*
 */
export interface ProjectFeedSliceDefaultPrimary {
  /**
   * Project field in *ProjectFeed → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: project_feed.default.primary.project[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  project: prismic.GroupField<
    Simplify<ProjectFeedSliceDefaultPrimaryProjectItem>
  >;
}
...
export type ProjectFeedSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<ProjectFeedSliceDefaultPrimary>,
  never
>;
 ...
 */
type ProjectFeedSliceVariation = ProjectFeedSliceDefault;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      MediaSliceDuoMedia,
      ProjectFeedSlice,
      ProjectFeedSliceDefaultPrimaryProjectItem,
      ProjectFeedSliceDefaultPrimary,
      ProjectFeedSliceVariation,
